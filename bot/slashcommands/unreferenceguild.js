...
module.exports.execute = async (Modules, bot, interaction, data, a,b,c,d,e,f,g,h) => {
        ...
        let initial_msg = `:warning: Vous êtes sur le point de supprimer ce Discord du référencement listant tous les Discords DirtyBiologistanais. Après suppression toutes les données liées seront __définitivement__ effacées (cela comprend l'activité des 7 et 31 derniers jours et tout autre statistique).\nLe Discord ne sera plus affiché sur le site et vous devrez refaire la commande de référencement.\n\nEtes vous sûr de vouloir faire ça ?`
