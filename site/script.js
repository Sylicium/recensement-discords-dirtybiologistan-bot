...
\`,",\`,\`,X,$,h,$,(, , , , , , , , , , , ,.,m,$,a,$,m,",',",\`
\`,^,.,+,$,a,$,q,\`, , , , .^. , .^. , , , ,l,8,o,b,$,1,.,\`,'
l,',^,O,$,a,$,J,., , , , , .___. , , , , ,",a,W,a,o,o,;,.,,
^,.,<,$,a,a,$,!, , , , , , , , , , , , , , ,],$,a,a,$,[,.,^
\`,',(,$,h,o,M,", , , , , , , , , , , , , , ,i,$,o,M,$,L,\`,'
\`,\`,0,$,h,a,$,(,",',., , , , , , , , ,.,',:,U,$,W,W,$,a,:,'
',,,b,8,a,W,W,$,o,w,Z,~,\`,., , ,',.,[,Z,w,$,$,8,$,M,W,$,!,.
',;,a,8,M,W,8,a,M,$,$,C,[,},[,?,|,_,U,$,M,*,M,$,8,M,*,$,>,.
',;,*,$,$,$,$,8,W,M,$,L,},\,/,\,Y,[,),$,b,*,M,8,$,*,a,$,>,.
',,,k,$,$,$,$,$,$,M,$,U,-,c,(,X,(,|,},m,M,*,8,8,$,M,*,$,!,.
\`,\`,0,$,8,$,$,$,8,a,$,1,},Y,(,m,1,/,U,{,$,W,8,$,$,W,8,b,:,'
\`,',(,$,M,$,$,8,a,$,X,1,\,Y,|,m,(,(,*,{,~,$,$,8,$,8,$,C,\`,'
^,.,<,$,*,8,W,a,$,/,-,m,|,z,X,U,X,|,p,d, ,],$,a,8,M,$,[,.,^
",',^,Q,$,a,k,$,1, ,(,w,(,|,Q,\,q,1,|,$,_,:,$,W,W,$,M,:,.,"
\`,\`,.,~,$,b,a,*,I,~,$,-,!,(,L,~,W,_,,,$,$,Y,a,$,*,$,1,.,\`,'
\`,^,\`,',c,$,h,a,d,$,$,!,:,/,{,.,q,),\`,a,$,$,8,*,$,Z,",',^,\`
\`,\`,\`,',,,O,$,M,$,a,$,],},U,_,^,a,$,1,b,$,*,a,$,8,l,.,\`,\`,\`
\`,\`,\`,\`,.,:,Z,$,o,M,W,o,$,-,>,Y,$,W,$,$,W,a,$,W,i,.,\`,^,^,\`
\`,\`,',,,\`,.,,,X,$,$,o,h,$,>,,,$,*,M,o,o,$,$,0,I,.,\`,',\`,\`,\`
\`,\`,\`,',:,\`,',\`,_,O,$,$,$,1,;,$,W,$,$,$,p,[,^,.,\`,',\`,\`,\`,\`
\`,\`,\`,\`,',\`,\`,\`,.,",~,/,q,p,C,$,h,p,X,-,,,.,',\`,^,\`,\`,\`,\`,\`
$,\`,\`,\`,\`,\`,\`,^,\`,',.,',^,;,!,l,;,",',.,',\`,^,\`,^,\`,\`,\`,\`,$
$,$,\`,\`,\`,\`,\`,\`,\`,^,^,\`,',',.,.,',',\`,^,^,\`,\`,\`,\`,\`,\`,\`,$,$`
        console.log("\n"+a+`
┌─────────┬─────────────────────────────────────┬─────────┐
│         └─ Référencement du DirtyBiologistan ─┘  v1.0.0 │
