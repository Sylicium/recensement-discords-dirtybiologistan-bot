...
let configuration = {
    ...
    logOnStart: false,
    ReplitName: "",
    workDirectoryFullPath: "c:\\Users\\Sylicium\\Documents\\DirtyBiologystan\\bot\\Référencement DirtyBiologistan V13",
    workDirectory: "\\Référencement DirtyBiologistan V13",
    replitMode: false
}
...
class Logger {
    constructor(logName) {
        ...
        this.logFile = {
            filePath: `${configuration.replitMode ? "/home/runner/ReferencementDBG/logs/" : "./logs/"}${fileInfos.fileName}.log`,
